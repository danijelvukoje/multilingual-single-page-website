...
<html lang="hr">
<head>
<title>Privatna praksa fizikalne terapije Deni Begovic</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="Privatna praksa fizikalne terapije Deni Begovic, fizikalna terapija, fizioterapeut, Deni, Begovic, Dubrovnik" />
<script type="application/x-javascript"> addEventListener("load", function() { setTimeout(hideURLbar, 0); }, false); function hideURLbar(){ window.scrollTo(0,1); } </script>
<!-- Custom Theme files -->
<link href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.3.4/css/bootstrap.min.css" type="text/css" rel="stylesheet" media="all">
<link href="css/style.css" type="text/css" rel="stylesheet" media="all"> 
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jquery.swipebox/1.3.0.1/css/swipebox.min.css">     
<link href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.5.2/animate.min.css" rel="stylesheet" type="text/css" media="all"> <!-- animation -->
<link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.0.3/css/font-awesome.min.css" rel="stylesheet"> <!-- font-awesome icons -->
<!-- //Custom Theme files --> 
<!-- js -->
...
<body>
		...
		<div class="container">
			<div class="dv-header">
				<div class="agileits-logo navbar-left">
					<!--<h1 class="wow animated" data-wow-delay=".5s"><a href="index.html">PHYSICAL THERAPY DENI BEGOVIC</a></h1>-->
					<h1 class="wow fadeInLeft animated" data-wow-delay=".5s" style="position:absolute;padding-right:15px;">
					<a href="index.html"><img class="img-responsive" height="300" width="500" src="images/logo-h-c-transparent.png" alt=""></a></h1>
				</div>
				<div class="navbar-right social-icons wow fadeInRight animated" data-wow-delay=".5s"> 
					<ul>
						<li><a id="gbimg" href="index.php?lang=gb" class="fa icon-border language"><img class="img-responsive" src="images/gb.svg" alt=""> </a></li>
						<li><a href="https://www.facebook.com/FizikalnaterapijaDeniBegovic/" class="fa fa-facebook icon-border facebook"> </a></li>
						<li><a href="https://www.instagram.com/deni.begovic/" class="fa fa-instagram icon-border instagram"> </a></li>
						<li><a href="https://www.linkedin.com/in/deni-begovic-a27b52a4/" class="fa fa-linkedin icon-border linkedin"> </a></li> 
						<li><a href="#contact" class="fa fa-envelope-o icon-border envelope-o"> </a></li>
					</ul>
				</div>
			...
			<div class="top-nav">
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-center effect">
							<li><a href="index.php">Početna</a></li>
							<li><a href="#about" class="scroll">O nama</a></li> 
							<li><a href="#services" class="scroll">Usluge</a></li> 
							<li><a href="#team" class="scroll">Naš tim</a></li>
							<li><a href="#gallery" class="scroll">Galerija</a></li>
			...
			<!-- navigation --> 
			<!-- arrow bounce --> 
			<div class="agileits-arrow bounce animated"><a href="#about" class="scroll"><i class="fa fa-chevron-circle-down" aria-hidden="true"></i></a></div>
			<!-- //arrow bounce -->
		</div> 
	</div>
	<!-- //banner -->
	...
	<div class="welcome" id="welcome">
		<div class="container">
			<h3 class="layout-title wow fadeInDown animated" data-wow-delay=".5s">Dobrodošli</h3>			
			<div class="welcome-info">
				<h2 class="wow fadeInLeft animated" data-wow-delay=".5s">Naše specijalizacije</h2>			
	...
	<div id="about" class="about">
		<!-- container -->
		<div class="container">
			<h3 class="layout-title wow fadeInDown animated" data-wow-delay=".5s">O nama</h3>	 
			<div class="about-agileitsrow">
				<div class="col-md-8 about-left wow slideInLeft animated" data-wow-delay=".5s">
					...
					<div class="col-md-8 col-sm-8 about-s-text wow zoomInRight animated" data-wow-delay=".9s">
				...
				<div class="col-md-4 about-right agileits wow slideInRight animated" data-wow-delay=".5s">
	...
	<div id="services" class="services">
		<!-- container -->
		<div class="container">
			<h3 class="layout-title wow fadeInDown animated" data-wow-delay=".5s">Usluge</h3> 
			<div class="services-row">
				<div class="col-md-3 col-sm-3 col-xs-6 services-agile-grid">
					<span class="glyphicon glyphicon-check dv-effect" aria-hidden="true"></span>
					<div class="services-text agileits"> 
						<p>Vivamus finibus</p>
					</div>
				</div>
				<div class="col-md-3 col-sm-3 col-xs-6 services-agile-grid">
					<span class="glyphicon glyphicon-user dv-effect" aria-hidden="true"></span>
					<div class="services-text">
						<p>Itaque ear</p>
					</div>
				</div>
				<div class="col-md-3 col-sm-3 col-xs-6 services-agile-grid">
					<span class="glyphicon glyphicon-heart-empty dv-effect" aria-hidden="true"></span>
					<div class="services-text agileits">
						<p>Mauris a quam</p>
					</div>
				</div>
				<div class="col-md-3 col-sm-3 col-xs-6 services-agile-grid">
					<span class="glyphicon glyphicon-bookmark dv-effect" aria-hidden="true"></span>
					<div class="services-text">
	...
	<div id="team" class="team">
		<div class="container">
			<h3 class="layout-title wow fadeInDown animated" data-wow-delay=".5s">Naš tim</h3>  
			<div class="team-info">
				<div class="col-md-4"></div>
				<div class="col-md-4 team-grids wow zoomIn animated" data-wow-delay=".5s">
	...
	<div id="gallery" class="gallery">
		<div class="container">
			<h3 class="layout-title wow fadeInDown animated" data-wow-delay=".5s">Galerija</h3>   
			<div class="sap_tabs">			
				<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
					<ul class="resp-tabs-list wow fadeInUp animated" data-wow-delay=".7s">
						<li class="resp-tab-item"><span>All</span></li>
						<li class="resp-tab-item"><span>Kategorija1</span></li>
						<li class="resp-tab-item"><span>Kategorija2</span></li>
						<li class="resp-tab-item"><span>Kategorija3</span></li>
						<li class="resp-tab-item"><span>Kategorija4</span></li>					
					</ul>	
					<div class="clearfix"> </div>	
					<div class="resp-tabs-container">
						<div class="tab-1 resp-tab-content">
							<div class="tab_img">
								<div class="col-md-4 col-sm-4 col-xs-6 gallery-grids">
								...
								<div class="col-md-4 col-sm-4 col-xs-6 gallery-grids grid-mdl">
									<div class="agileinfo-effect  wow fadeInUp animated" data-wow-delay=".5s">
			...
			<!-- //ResponsiveTabs -->
			<!-- swipe box js -->
			<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.swipebox/1.3.0.1/js/jquery.swipebox.min.js"></script> 
				<script type="text/javascript">
					jQuery(function($) {
						$(".swipebox").swipebox();
					});
	...
	<div class="testimonial services">
		<!-- container -->
		<div class="container">
			<h3 class="layout-title wow fadeInDown animated" data-wow-delay=".5s">Naše recenzije</h3> 
			 <div id="myCarousel" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner" role="listbox">
					<div class="item active agileits-layout">
					...
					<div class="item agileits-layout"> 
						<div class="carousel-caption">
							<div class="testimonial-grids">
								<div class="testimonial-left">
	...
	<div class="contact" id="contact"> 
		<div class="container">
			<h3 class="layout-title wow fadeInDown animated" data-wow-delay=".5s">Kontaktirajte nas</h3> 
			<div class="contact-form">
				<div class="col-md-7 contact-right wow fadeInRight animated" data-wow-delay=".5s">
					...
					<form action="#" method="post">  
						...
						<input class="wow zoomIn animated" data-wow-delay=".5s" type="submit" value="POŠALJI" > 
					</form>
				</div>
				<div class="col-md-5 contact-left">
					<div class="address wow fadeInLeft animated" data-wow-delay=".5s">
						<h5>Adresa:</h5>
						<p><i class="glyphicon glyphicon-home"></i> Vukovarska 30, 20000 Dubrovnik, Croatia </p>
					</div>
					<div class="address address-mdl wow fadeInLeft animated" data-wow-delay=".5s">
						<h5>Telefoni:</h5>
						<p><i class="glyphicon glyphicon-earphone"></i>  +385 99 333 9919</p>
						<p><i class="glyphicon glyphicon-phone"></i> +385 20 311 006</p>
					</div>
					<div class="address wow fadeInLeft animated" data-wow-delay=".5s">
						<h5>Email:</h5>
						<p><i class="glyphicon glyphicon-envelope"></i> <a href="mailto:ftbegovic@gmail.com">ftbegovic@gmail.com</a></p>
					</div>
				</div>
				<div class="clearfix"></div>
			</div>
		</div>
		<div class="agileits-layout-map wow zoomIn animated" data-wow-delay=".5s">
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2934.462251746243!2d18.089792915232685!3d42.651558824635714!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x134c75290d4ffbe5%3A0x1bea406fc762281f!2sFizikalna+terapija+Deni+Begovi%C4%87!5e0!3m2!1shr!2sno!4v1508698890601" allowfullscreen></iframe>
		</div>
	</div>
	<!-- //contact -->	
	<!-- footer -->
	<div class="footer">
		<div class="container">
			<div class="col-md-4 col-md-offset-2 footer-grids wow fadeInLeft animated" data-wow-delay=".5s">
				<h3>Informacije:</h3>
			...
			<div class="col-md-4 footer-grids wow fadeInLeft animated" data-wow-delay=".5s">
				<h3>Radno vrijeme:</h3>
				<h5><b>Pon - Pet:</b> 08:00 - 16:00 </h5>
				<h5><b>Sub - Ned:</b> Zatvoreno</h5>
			</div>
			<div class="clearfix"> </div>
		</div>
	</div>
	...
	<div class="footer-bottom">
		<div class="container"> 
			<p>Fizikalna terapija Deni Begovic © 2017 | All rights reserved</p>
		</div>
	</div>  
	<!-- //copy right -->
	<!-- animation --> 
