...
<html lang="gb">
<head>
<title>Private practice of physical therapy Deni Begovic</title>
...
<body>
		...
		<div class="container">
			<div class="dv-header">
				...
				<div class="navbar-right social-icons wow fadeInRight animated" data-wow-delay=".5s"> 
					<ul>
						<li><a id="hrimg" href="index.php?lang=hr" class="fa icon-border language"><img class="img-responsive" src="images/hr.svg" alt=""> </a></li>
	...
	<div class="welcome" id="welcome">
		<div class="container">
			<h3 class="layout-title wow fadeInDown animated" data-wow-delay=".5s">Welcome </h3>			
	...
	<div id="about" class="about">
		<!-- container -->
		<div class="container">
			<h3 class="layout-title wow fadeInDown animated" data-wow-delay=".5s">About Us</h3>	 
	...
	<div id="services" class="services">
		<!-- container -->
		<div class="container">
			<h3 class="layout-title wow fadeInDown animated" data-wow-delay=".5s">Services</h3> 
	...
	<div id="team" class="team">
		<div class="container">
			<h3 class="layout-title wow fadeInDown animated" data-wow-delay=".5s">Our Team</h3>  
			<div class="team-info">
	...
	<div id="gallery" class="gallery">
		<div class="container">
			<h3 class="layout-title wow fadeInDown animated" data-wow-delay=".5s">Gallery</h3>   
			<div class="sap_tabs">			
	...
	<div class="testimonial services">
		<!-- container -->
		<div class="container">
			<h3 class="layout-title wow fadeInDown animated" data-wow-delay=".5s">Feedback About us</h3> 
	...
	<div class="contact" id="contact"> 
		<div class="container">
			<h3 class="layout-title wow fadeInDown animated" data-wow-delay=".5s">Contact Us</h3> 
	...
	<div class="footer">
		<div class="container">
			...
			<div class="col-md-4 footer-grids wow fadeInLeft animated" data-wow-delay=".5s">
				<h3>Office Hours :</h3>
				<h5><b>Mon - Fri:</b> 8am - 4pm </h5>
				<h5><b>Sat - Sun:</b> Closed</h5>
			</div>
			<div class="clearfix"> </div>
		</div>
	</div>
	...
	<div class="footer-bottom">
		<div class="container"> 
			<p>Physical therapy Deni Begovic © 2017 | All rights reserved</p>
		</div>
	</div>  
	<!-- //copy right -->
	<!-- animation --> 
